...
export default function QuizResults() {
  ...
  // 👇 YAHAN HAI NAYA UPDATED FUNCTION 👇
  const handleGenerateRanks = async () => {
    if (!quiz) return

    setGenerating(true)
    try {
      // 1. Update all attempts to mark them as evaluated
      ...
      // 2. Quiz table me show_results_immediately ko TRUE (Publish) karo
      ...
      // Local state update taaki UI me dikhe
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex gap-4 mb-6">
          <Button onClick={handleGenerateRanks} disabled={generating || attempts.length === 0 || quiz?.show_results_immediately}>
            <Trophy className="w-4 h-4 mr-2" />
            {generating ? 'Generating...' : quiz?.show_results_immediately ? 'Results Already Published' : 'Generate Ranks & Publish Results'}
          </Button>
