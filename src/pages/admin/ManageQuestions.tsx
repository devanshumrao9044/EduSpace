...
import { ArrowLeft, Plus, Trash2, Upload, Download, Loader2, FileText } from 'lucide-react'
...
export default function ManageQuestions() {
  ...
  /* ─── CSV UPLOAD LOGIC (MOBILE AUTO-FIX) ─── */
  const handleCSVUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = async (event) => {
      ...
      // 🔥 JADOO: Agar lines chipki hui hain, toh ye unhe sahi karega
      // Ye dhoondhega jahan marks (number) ke baad " shuru ho raha hai bina line break ke
      ...
      Papa.parse(fixedText, {
        ...
        complete: async (results) => {
          try {
            ...
            if (csvQuestions.length === 0) throw new Error("No valid questions found")
