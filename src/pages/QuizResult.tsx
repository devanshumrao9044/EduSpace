...
export default function QuizResult() {
  ...
  const showDetailedResults = attempt.is_evaluated || quiz.show_results_immediately
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex justify-between text-sm">
              ...
              <Badge variant={attempt.is_evaluated ? 'default' : 'secondary'}>
                {attempt.is_evaluated ? 'Published' : 'Pending Evaluation'}
              </Badge>
            </div>
          </CardContent>
        </Card>
          ...
          <Card>
            <CardContent className="text-center py-12">
              ...
              <p className="text-muted-foreground mb-6">
                Your quiz is being evaluated. Results will be published soon by the instructor.
              </p>
